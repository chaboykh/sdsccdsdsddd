...
# ===== CONFIGURATION =====
TOKEN = os.getenv("DISCORD_BOT_TOKEN")  # Must be set as env var in Render.com
PREFIX = "!"
XP_MIN = 5
XP_MAX = 15
...
def generate_rank_card(user: discord.Member, level: int, xp: int, needed: int):
    ...
    bar_x, bar_y = 250, 170
    draw.rectangle([bar_x, bar_y, bar_x + bar_width, bar_y + bar_height], fill=(90, 70, 40))
